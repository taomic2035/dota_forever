...
**TypeScript + Canvas2D,零运行时依赖,266 项单元/仿真测试,AI 整局对战可分出胜负。**
...
**寒霜连锁**(弹道弹跳递增)/ **吞噬成长** / **末日**(沉默+缴械+灼烧)/ 海妖外壳(伤害减免+自净)等。
...
> 完整 46 名见 `src/data/heroes/`(`index.ts` + `batch2~8.ts`),游戏内选人界面可查看全部技能 tooltip。
...
tests/      266 项:战斗矩阵/经济/寻路/视野/技能/合成/野区/Boss/英雄技能/物品/整局仿真
```
