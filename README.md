...
**TypeScript + Canvas2D,零运行时依赖,470 项单元/仿真测试,AI 整局对战可分出胜负。**
...
> 完整 100 名见 `src/data/heroes/`(`index.ts` + `batch2~17.ts`),游戏内选人界面可查看全部技能 tooltip。
