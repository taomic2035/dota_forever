...
**TypeScript + Canvas2D,零运行时依赖,484 项单元/仿真测试,AI 整局对战可分出胜负。**
...
> 完整 106 名见 `src/data/heroes/`(`index.ts` + `batch2~18.ts`),游戏内选人界面可查看全部技能 tooltip。
