...
**TypeScript · 2D(Canvas2D)与可选真 3D(Three.js)双渲染器 · 1300+ 项单元/仿真测试 · AI 整局对战可分出胜负。**
...
tests/      1300+ 项:战斗矩阵/经济/寻路/视野/技能/合成/野区/Boss/英雄技能/物品/美术描述符/特效/选择操控/预览形状/确定性/整局仿真
```
...
- 单位无相互碰撞 / 卡位(body-block):碰撞半径用于攻击距离判定,位移阶段不互相阻挡(有意简化)
