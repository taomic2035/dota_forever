...
**TypeScript + Canvas2D,零运行时依赖,315 项单元/仿真测试,AI 整局对战可分出胜负。**
...
> 完整 58 名见 `src/data/heroes/`(`index.ts` + `batch2~10.ts`),游戏内选人界面可查看全部技能 tooltip。
...
tests/      315 项:战斗矩阵/经济/寻路/视野/技能/合成/野区/Boss/英雄技能/物品/整局仿真
```
