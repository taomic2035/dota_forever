...
**英雄(34 名全原创,机制致敬经典原型,持续分批扩充中)**

每名英雄都有 3 个普通技能 + 1 个大招(QWER),含独立 AI 释放评分。支持的英雄机制涵盖:
先手开团 / 物理核心 / 法系爆发 / 治疗护盾 / 召唤(树人·守卫)/ **幻象**(分身出伤打折受伤翻倍)/
嘲讽 / 反伤 / 换位 / 处决 / 流形变身 / 承伤减免 / 法术增强 / 强制黑夜 等。
...
> 完整 34 名见 `src/data/heroes/`(`index.ts` + `batch2~6.ts`),游戏内选人界面可查看全部技能 tooltip。
